...
namespace MfGames.HierarchicalPaths
{
    ...
    public class HierarchicalPath : IComparable<HierarchicalPath>
    {
        ...
        public IList<string> Levels
        {
            get
            {
                return new List<string>(this.levels);
            }
        }
        ...
        public HierarchicalPath Parent
        {
            get
            {
                ...
                {
                    return this.isRelative ? RelativeRoot : AbsoluteRoot;
                }

                // Create a new path without the last item in it.
                var parentLevels = new string[this.levels.Length - 1];
        ...
        public bool Equals(HierarchicalPath other)
        {
            ...
            if (other.isRelative != this.isRelative)
            {
                return false;
            }
            ...
            if (otherLevels.Length != this.levels.Length)
            {
                return false;
            }
            ...
            {
                if (!otherLevels[i].Equals(this.levels[i]))
                {
                    return false;
                }
            }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals((HierarchicalPath)obj);
        }
        ...
        public HierarchicalPath GetPathAfter(HierarchicalPath rootPath)
        {
            ...
            var newLevels =
                new string[this.levels.Length - rootPath.levels.Length];

            for (int index = rootPath.levels.Length;
                index < this.levels.Length;
                index++)
            {
                newLevels[index - rootPath.levels.Length] = this.levels[index];
            }
        ...
        /// The count.
        /// </param>
        /// <param name="makeRelative">
        /// if set to <c>true</c> [make relative].
        /// </param>
        /// <returns>
        /// </returns>
        public HierarchicalPath Splice(
        ...
        public bool StartsWith(HierarchicalPath path)
        {
            ...
            if (this.levels.Length < path.levels.Length)
            {
                return false;
            }

            // If our root type isn't the same, then they don't match.
            if (this.isRelative != path.isRelative)
            {
                return false;
            }
            ...
            {
                if (this.levels[index] != path.levels[index])
                {
                    return false;
                }
            }
            ...
            HierarchicalPathOptions options)
        {
            ...
            if (path.Length == 1)
            {
                ...
                if (path == ".")
                {
                    ...
                    if (context != null)
                    {
                        this.isRelative = context.IsRelative;
