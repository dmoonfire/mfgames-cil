...
namespace MfGames.IO
{
        ...
        where TStream : Stream
    {
        ...
        public override bool CanTimeout
        {
            get
            {
                return this.underlyingStream.CanTimeout;
            }
        }
        ...
        public override int ReadTimeout
        {
            get
            {
                return this.underlyingStream.ReadTimeout;
            }

            set
            {
                this.underlyingStream.ReadTimeout = value;
            }
        }
        ...
        public override int WriteTimeout
        {
            get
            {
                return this.underlyingStream.WriteTimeout;
            }

            set
            {
                this.underlyingStream.WriteTimeout = value;
            }
        }
        ...
        {
            return this.underlyingStream.CreateObjRef(requestedType);
        }
        ...
        {
            return this.underlyingStream.InitializeLifetimeService();
        }
