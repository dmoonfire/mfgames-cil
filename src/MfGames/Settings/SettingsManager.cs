...
namespace MfGames.Settings
{
	...
	public class SettingsManager
	{
		...
		/// </summary>
		public int Count { get { return objectSettings.Count + xmlSettings.Count; } }

		/// <summary>
		/// Gets the number of deserialized settings.
		/// </summary>
		public int LoadedCount { get { return objectSettings.Count; } }
		...
		/// </summary>
		public int StoredCount { get { return xmlSettings.Count; } }
			...
			out SettingsManager containingManager) where TSetting : class, new()
		{
			...
			bool parentSettingsFirst = GetParentSettingsFirst(
				searchOptions);
