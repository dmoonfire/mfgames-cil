...
namespace MfGames.Xml
{
	...
	public class XmlProxyReader : XmlReader
	{
		...
		///   </returns>
		public override string BaseURI { get { return UnderlyingReader.BaseURI; } }
		...
		///   </returns>
		public override int Depth { get { return UnderlyingReader.Depth; } }
		...
		///   </returns>
		public override bool EOF { get { return UnderlyingReader.EOF; } }
		...
		///   </returns>
		public override bool HasValue { get { return UnderlyingReader.HasValue; } }
		...
		///   </returns>
		public override string Prefix { get { return UnderlyingReader.Prefix; } }
		...
		///   </returns>
		public override string Value { get { return UnderlyingReader.Value; } }
