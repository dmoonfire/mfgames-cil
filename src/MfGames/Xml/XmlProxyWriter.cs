// <copyright file="XmlProxyWriter.cs" company="Moonfire Games">
...
namespace MfGames.Xml
{
    ...
    public class XmlProxyWriter : XmlWriter
    {
        ...
        public override WriteState WriteState
        {
            get
            {
                return this.UnderlyingWriter.WriteState;
            }
        }
        ...
        {
            return this.UnderlyingWriter.LookupPrefix(ns);
        }
        ...
        {
            this.UnderlyingWriter.WriteCData(text);
        }
        ...
        {
            this.UnderlyingWriter.WriteCharEntity(ch);
        }
        ...
        {
            this.UnderlyingWriter.WriteComment(text);
        }
        ...
        {
            this.UnderlyingWriter.WriteEndAttribute();
        }
        ...
        {
            this.UnderlyingWriter.WriteEntityRef(name);
        }
        ...
        {
            this.UnderlyingWriter.WriteFullEndElement();
        }
        ...
        {
            this.UnderlyingWriter.WriteRaw(data);
        }
        ...
        {
            this.UnderlyingWriter.WriteStartDocument(standalone);
        }
        ...
        {
            this.UnderlyingWriter.WriteString(text);
        }
        ...
        {
            this.UnderlyingWriter.WriteWhitespace(ws);
        }
